...
class DiscussionSentimentStatsCard extends StatelessWidget {
  final List<DiscussionComment> comments;
  final double? discussionSentimentScore;
  final double? discussionSentimentMagnitude;

  const DiscussionSentimentStatsCard({
    super.key,
    required this.comments,
    this.discussionSentimentScore,
    this.discussionSentimentMagnitude,
  });
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (discussionSentimentScore != null && discussionSentimentMagnitude != null) ...[
              const SizedBox(height: 16),
              Text(
                ...
                children: [
                  Expanded(
                    child: _buildMetricCard(
                      context,
                      'Score',
                      discussionSentimentScore!.toStringAsFixed(2),
                  ...
                  Expanded(
                    child: _buildMetricCard(
                      context,
                      'Magnitude',
                      discussionSentimentMagnitude!.toStringAsFixed(2),
